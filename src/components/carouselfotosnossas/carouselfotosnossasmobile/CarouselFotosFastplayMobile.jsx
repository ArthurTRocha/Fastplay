...
import "./carouselfotosfastplaymobile.css"




function CarouselFotosFastplayMobile() {
    ...
    return (
      <div className="carouselFotosFastplayMobile">
        <Slider {...settings}>
          <div className="carouselFotosMobile">
...
export default CarouselFotosFastplayMobile;
